...
🎨 뱃지 색상 옵션
===============================================
blue / green / orange / purple / red / yellow / lightgrey / brightgreen

🔧 로고 옵션 (logo= 뒤에 넣기)
- 서버/백엔드: node.js / django / spring / fastapi
- 모바일: android / apple / flutter / react
- 데스크탑: windows / electron
- 기타: github / docker / kubernetes

📝 뱃지 추가하는 법
[![표시이름](https://img.shields.io/badge/리포이름-설명-색상?style=for-the-badge&logo=로고)](https://github.com/KBitone-Company/리포이름)

예시)
[![Server](https://img.shields.io/badge/내리포이름-서버-blue?style=for-the-badge&logo=node.js)](https://github.com/KBitone-Company/내리포이름)
===============================================
-->
...
[![Server](https://img.shields.io/badge/KLINK_STD_Server-서버-blue?style=for-the-badge&logo=spring)](https://github.com/KBitone-Company/KLINK_STD_Server)
